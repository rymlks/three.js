...
BufferGeometry4D.prototype = Object.assign( Object.create( EventDispatcher.prototype ), {

	constructor: BufferGeometry4D,
	...
	setFromObject: function ( object ) {
		...
		if ( object.isPoints || object.isLine ) {
			...
			var positions = new Float32BufferAttribute( geometry.vertices.length * 4, 4 );
			var colors = new Float32BufferAttribute( geometry.colors.length * 3, 3 );

			this.setAttribute( 'position', positions.copyVector4sArray( geometry.vertices ) );
