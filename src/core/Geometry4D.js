...
Geometry4D.prototype = Object.assign( Object.create( EventDispatcher.prototype ), {

	constructor: Geometry4D,

	isGeometry: true,

	applyMatrix4: function ( matrix ) {

		var normalMatrix = new Matrix4().getNormalMatrix( matrix );
	...
	mergeVertices: function () {
		...
		for ( i = 0, il = this.vertices.length; i < il; i ++ ) {
			...
			v = this.vertices[ i ];
			key = Math.round( v.x * precision ) + '_' + Math.round( v.y * precision ) + '_' + Math.round( v.z * precision ) + '_' + Math.round( v.w * precision );
