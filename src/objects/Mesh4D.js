...
Mesh4D.prototype = Object.assign( Object.create( Object4D.prototype ), {
	...
	copy: function ( source ) {
		console.error( 'THREE.Mesh4D: .copy() is not done.' );

		Object4D.prototype.copy.call( this, source );
	...
	updateMorphTargets: function () {
		...
		if ( geometry.isBufferGeometry ) {
			...
			if ( morphTargets !== undefined && morphTargets.length > 0 ) {
				...
				console.error( 'THREE.Mesh4D.updateMorphTargets() no longer supports THREE.Geometry. Use THREE.BufferGeometry instead.' );
	...
	raycast: function ( raycaster, intersects ) {
		console.error( 'THREE.Mesh4D: .raycast() is not done.' );
...
function checkIntersection( object, material, raycaster, ray, pA, pB, pC, point ) {
	console.error( 'THREE.Mesh4D: .checkIntersection() is not done.' );
...
function checkBufferGeometryIntersection( object, material, raycaster, ray, position, morphPosition, morphTargetsRelative, uv, uv2, a, b, c ) {
	console.error( 'THREE.Mesh4D: .checkBufferGeometryIntersection() is not done.' );
